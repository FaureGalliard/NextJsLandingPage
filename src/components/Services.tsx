  ...
  const services = [
    {
      ...
      title: 'Ajustes y Confección',
      description: 'Mejoramos y adaptamos tus prendas para que queden perfectas, con ajustes precisos y detalles cuidados.',
      features: ['Camisas, pantalones, vestidos y trajes', 'Ajustes de tallas', 'Reparaciones y modernización'],
    },
    {
      icon: (
      ...
      title: 'Ternos y Vestuario a Medida',
      description: 'Disfruta de trajes elegantes y personalizados para cualquier ocasión, listos para alquilar o a tu medida.',
      features: ['Ternos elegantes', 'Camisas y vestidos a medida', 'Opciones de alquiler'],
      popular: true,
      elevated: true,
    },
    {
      ...
      title: 'Cuidado y Limpieza de Prendas',
    description: 'Mantén tus prendas impecables con nuestro cuidado profesional, desde limpieza delicada hasta mantenimiento especializado.',
    features: ['Tintorería profesional', 'Lavandería delicada', 'Protección de telas y acabados'],
    ...
    <section id="services" className="py-24 bg-[#f5f0eb]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-[#000000] text-3xl md:text-4xl font-serif mb-4">Servicios de Sastrería</h2>
          <p className="text-gray-600">Elige el nivel de personalización que se adapte a tus necesidades.</p>
        </div>
        <div className="text-[#000000] grid grid-cols-1 md:grid-cols-3 gap-8">
